...
#Fin Iniciar variables
    ...
    def get_lines_in_file_dict(self, path : str) -> dict:
        try:
            ...
            print("Error Leer Archivo NPesaje: "+str(e))
    ...
    def check_cameras_on(self):
        ...
        try:            
            ...
            self.escribirArchivoLog("Error Cameras OFF: "+str(e))
            self.enviar_mensaje_correo("Error de las cámaras al iniciar sistema, se reiniciará el equipo")
            return False
        ...
        try:
            ...
            while True:
                ...
                if validar == True:
                    ...
                    #*****************************************
                    #*****************************************
                    # Validar que este sin error la medición
                    ...
                    if num_error > num_ok:
                        ...
                        self.post_archivo_txt("CAMERAS-NOT-WORK")
                        self.escribirArchivoLog("Error camarás con error 0.0: "+str(e))
    ...
    def crearCarpetaExportar(self):
        ...
        if not exists(path_exportar):
            ...
            #print('Ya existe la carpeta se va a borrar')
            shutil.rmtree(path_exportar, ignore_errors=True)
            time.sleep(2)
            makedirs(path_exportar)
            makedirs(path_exportar+"/Img")
            makedirs(path_exportar+"/Img/Camara-Top")
    ...
    def medicion_full_estereo_autocargante(self,parte_camion : str,
        ...
        base_grupo1 = base_grupo1 / 100
        base_grupo2 = base_grupo2 / 100
        if base_grupo1 > limites_error_altura_base[0]:
            base_grupo1 = CONSTANTE_BASE
        if base_grupo1 < limites_error_altura_base[1]:
            base_grupo1 = CONSTANTE_BASE

        if base_grupo2 > limites_error_altura_base[0]:
            base_grupo2 = CONSTANTE_BASE
        if base_grupo2 < limites_error_altura_base[1]:
            base_grupo2 = CONSTANTE_BASE
    ...
    def post_graficar_3D(self,lista_graficar_camion : list, 
        ...
        try:
            ...
            if inicio_camion != 0 and \
                ...
                print(self.MR_CAMION_E)
                MR_CAMION = 'MR_CAMION='+str(self.MR_CAMION_E)

                print(self.MR_CARRO_E)
    ...
    def post_mediciones_txt(self, name : str,path = path):
        try:
            ...
            mensaje = ("<--PLAN-B-->\n"+
                        ...
                        "<--PLAN-C-->\n"+
                        "VELOCIDAD_PROMEDIO_TOTAL="+str(self.VELOCIDAD_PROMEDIO_TOTAL)+"\n"+
